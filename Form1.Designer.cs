namespace Mansoura_G1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataSet11 = new Mansoura_G1.DataSet1();
            ...
            // sqlSelectCommand1
            // 
            this.sqlSelectCommand1.CommandText = "SELECT        Id, Name\r\nFROM            Department";
            this.sqlSelectCommand1.Connection = this.sqlConnection1;
            // 
            // sqlInsertCommand1
            // 
            this.sqlInsertCommand1.CommandText = "INSERT INTO [Department] ([Id], [Name]) VALUES (@Id, @Name);\r\nSELECT Id, Name FRO" +
    "M Department WHERE (Id = @Id)";
            ...
            // sqlDeleteCommand1
            // 
            this.sqlDeleteCommand1.CommandText = "DELETE FROM [Department] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND " +
    "[Name] IS NULL) OR ([Name] = @Original_Name)))";
            ...
            // button4
            // 
            this.button4.Location = new System.Drawing.Point(630, 326);
